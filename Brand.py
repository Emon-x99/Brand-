...
\033[1;32m[-] VERSION   :\033[1;32m 3.5
\033[1;32m[-] AUTHOR    :\033[1;32m Md Yasin Ahmed emon 
\033[1;32m[-] GITHUB    :\033[1;32m Emon-x99 
\033[1;32m[-] FACEBOOK  :\033[1;32m MD Yasin Ahmed emon 
\033[1;92m══════════════════════════════════════════
...
a=requests.get("https://github.com/Emon-x99/Brand-/pulls").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
    ...
    print("Your key  : "+key2)
    print("\n\t\tContact Admin ")
    os.system('xdg-open https://wa.me/+8801317377920')
    exit()
class Main:
    def __init__(self):
        self.id = []
        ...
        os.system("clear")
        print(logo)
        os.system('xdg-open https://www.facebook.com/profile.php?id=100054925285605&mibextid=ZbWKwL')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sEmon\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
